      ...
      <>
        <div className="flex flex-col items-center">
          <button
            ...
            className="group relative grid h-24 w-24 place-items-center rounded-full bg-brand text-brand-foreground transition-transform active:scale-95 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-brand/30 select-none touch-none"
          >
  ...
  return (
    <>
      <button
        ...
        onContextMenu={(e) => e.preventDefault()}
        aria-label="Tap to speak, or hold and release to send"
        className="relative grid size-14 shrink-0 place-items-center rounded-full bg-brand text-brand-foreground active:scale-95 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-brand/30 select-none touch-none"
      >
