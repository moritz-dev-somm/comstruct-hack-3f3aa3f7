...
export const PERIODS: { id: Period; label: string }[] = [
  { id: "woche", label: "This week" },
  { id: "monat", label: "This month" },
  { id: "quartal", label: "Last quarter" },
  { id: "jahr", label: "This year" },
];
...
export function buildDailySeries(period: Period) {
  ...
  for (let i = days - 1; i >= 0; i--) {
    ...
    if (dow === 0) base = 0;
    if (dow === 6) base *= 0.25;
    if (rand() < 0.08) base = 300 + rand() * 150;
    const spend = Math.round(base * (scale / (days / 21)));
    raw.push(spend);
...
export const BY_PROJECT_BASE = [
  ...
  { project: "Warehouse New Build", total: 760 },
  { project: "Post Building Refurb", total: 604 },
];

export const BY_CATEGORY_BASE = [
  { name: "Fasteners", value: 1200, pct: 28, color: "#16A34A", top: "Spax 5×60" },
  { name: "PPE", value: 1028, pct: 24, color: "#2563EB", top: "Safety gloves L" },
  { name: "Electrical", value: 814, pct: 19, color: "#0D9488", top: "Cable ties black" },
  { name: "Tools", value: 685, pct: 16, color: "#D97706", top: "Cordless driver" },
  { name: "Other", value: 557, pct: 13, color: "#6B7280", top: "Cleaning supplies" },
];
...
export const SUPPLIERS_BASE: SupplierRow[] = [
  { name: "ACME Construction", orders: 28, spend: 2140, compliance: 100, leadTime: "3.2 days", status: "active", statusLabel: "✓ Contract active" },
  { name: "Würth AG", orders: 11, spend: 980, compliance: 100, leadTime: "2.8 days", status: "active", statusLabel: "✓ Contract active" },
  { name: "Bosch Professional", orders: 5, spend: 620, compliance: 82, leadTime: "4.1 days", status: "partial", statusLabel: "⚠ Partially compliant" },
  { name: "Fischer", orders: 3, spend: 320, compliance: 100, leadTime: "3.0 days", status: "active", statusLabel: "✓ Contract active" },
  { name: "Other (4)", orders: 0, spend: 224, compliance: 0, leadTime: "—", status: "none", statusLabel: "✗ No contract" },
];
...
export const FOREMEN_BASE: ForemanRow[] = [
  ...
  { foreman: "Peter Hofer", project: "Warehouse New Build", orders: 9, spend: 760, avg: 84.4, trend: -8 },
  { foreman: "Thomas Meier", project: "Post Building Refurb", orders: 6, spend: 604, avg: 100.7, trend: 22 },
];

export const WEEKDAY = [
  { day: "Mon", value: 12, weekend: false },
  { day: "Tue", value: 8, weekend: false },
  { day: "Wed", value: 9, weekend: false },
  { day: "Thu", value: 7, weekend: false },
  { day: "Fri", value: 8, weekend: false },
  { day: "Sat", value: 2, weekend: true },
  { day: "Sun", value: 1, weekend: true },
];
...
export const APPROVAL_TIMES = [
  ...
  { bucket: "1–4 hrs", value: 3, color: "#EA580C" },
  { bucket: "> 4 hrs", value: 2, color: "#DC2626" },
];

export const APPROVAL_TIERS = [
  { name: "Auto-approved < 200 CHF", value: 31, pct: 66, color: "#16A34A" },
  { name: "PM approval 200–2000 CHF", value: 14, pct: 30, color: "#D97706" },
  { name: "Central procurement > 2000 CHF", value: 2, pct: 4, color: "#DC2626" },
];

export const REJECTIONS = [
  { reason: "Wrong supplier (off-contract)", count: 2 },
  { reason: "Quantity too high", count: 1 },
];
